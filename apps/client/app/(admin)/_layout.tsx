...
import { Platform, View, Text, Pressable, useWindowDimensions, useColorScheme, ActivityIndicator, Image } from 'react-native';
...
export default function AdminLayout() {
  ...
  if (isLoading) {
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: BRAND_COLORS.canvasBg }}>
  ...
  if (isDesktop) {
    return (
      <View style={{ flex: 1, flexDirection: 'row', backgroundColor: BRAND_COLORS.canvasBg }}>
        {/* Modern Premium Sidebar with Official Brand Palette */}
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View>
                  ...
                  <Text style={{ fontSize: 10, color: BRAND_COLORS.accentText, fontWeight: '700' }}>
                    Super Admin
                  </Text>
                </View>
              </View>
